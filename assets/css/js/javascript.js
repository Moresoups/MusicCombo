...
console.log("Red Hot Chili Peppers");
...
console.log("The White Stripes");

else if ((Wind == false) && (Earth == true) && (Water == true) && (Fire == false) && (Dark == false) && (Light == false))
console.log("The Heavy");

else if ((Wind == false) && (Earth == true) && (Water == flase) && (Fire == true) && (Dark == false) && (Light == false))
console.log("The Comet is Coming");
